...
public class RedBlackBST<Key extends Comparable<Key>, Value> {
    ...
    ***************************************************************************/
    ...
    {
        int cont=0;
          for(Node no = root; no!=null; no = no.right)
          {
              if(no!=null && no.color==false)
                  cont++;
          }
          return cont;
    }
